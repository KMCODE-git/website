...
export const soundFiles = {
  ...
  pokemon: "/sounds/pokemon.mp3",
  grogu: "/sounds/grogu.mp3",
  mario: "/sounds/mario.mp3",
  one_piece: "/sounds/one_piece.mp3",
  ps5: "/sounds/ps5.mp3",
...
export const exclusiveSoundIds = new Set<string>(["pokemon", "grogu", "mario", "one_piece", "ps5", "ambiance_sound"]);
