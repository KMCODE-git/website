...
7. Si le dépôt continue de grossir avec d'autres assets lourds, reconsidérer Git LFS plutôt que des `.glb` committés directement (`office.glb` reste sous la limite GitHub pour l'instant, mais l'avertissement à 50 Mo est un signal à surveiller).
